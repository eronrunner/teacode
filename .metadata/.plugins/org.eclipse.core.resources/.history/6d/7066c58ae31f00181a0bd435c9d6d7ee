...
//	final public static String HIBERNATE_PROPERTY_CACHE_REGION_FACTORY_CLASS = env.getProperty("hibernate.property.cache.region.factory_class");
	...
	public Properties properties(){
		...
		properties.put("hibernate.format_sql", env.getProperty("hibbernate.property.format_sql"));
		properties.put("hibernate.connection.autocommit", env.getProperty("hibernate.property.autocommit"));
		properties.put("hibernate.dialect", env.getProperty("hibernate.properties.dialect"));
